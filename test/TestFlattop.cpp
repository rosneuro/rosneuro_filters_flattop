...
namespace rosneuro {
    ...
    TEST_F(FlattopTestSuite, Integration){
        std::string base_path = ros::package::getPath("rosneuro_filters_flattop");
        ...
        DynamicMatrix<double> output = flattop_filter->apply(input);
